...
export function FaqMapQuestion() {
      ...
      <div className="bg-white px-16p mt-20p pb-12p">
        ...
        {faqs.map((faq) => (
          ...
          >
            ...
            >
              <div className="flex justify-between items-center pr-50p pb-20p">
                <p className="text-16p font-inter">{faq.answer}</p>
              </div>
            </div>
          </div>
        ))}
